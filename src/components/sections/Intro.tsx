...
function IconFlower({ className }: { className: string }) {
  return (
    <svg className={className} version="1.1" viewBox="0 0 512 512" width="30px">
      <g id="_x35_40_x2C__love_x2C__flower_x2C__wedding_x2C__heart">
        <g>
          ...
          />
          <path
            d="M267.56,412.07c-1.279,0-2.56-0.488-3.535-1.465l-63.43-63.43c-1.953-1.952-1.953-5.118,0-7.07    c1.953-1.953,5.118-1.953,7.071,0l63.429,63.43c1.953,1.952,1.953,5.118,0,7.07C270.119,411.582,268.839,412.07,267.56,412.07z"
            fill="#849B31"
          />
          <path
